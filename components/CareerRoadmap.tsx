  ...
  return (
    <div className="max-w-6xl mx-auto p-6 space-y-6">
      <div className="text-center">
        <h1 className="text-3xl font-bold text-gray-800 mb-2">Career Roadmap</h1>
        <p className="text-gray-600">Get a personalized roadmap to achieve your career goals</p>
      </div>
